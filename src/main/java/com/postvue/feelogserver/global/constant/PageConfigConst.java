...
public final class PageConfigConst {
	...
	public static final Integer MSG_CONVERSATION_PAGE_NUM = 20;

	public static final Integer PROFILE_SCRAP_PAGE_NUM = 20;

	public static final Integer PROFILE_CLIP_PAGE_NUM = 20;

	public static final Integer MSG_BLOCK_ROOM_PAGE_NUM = 50;

	//
	public static final Integer SCRAP_PREVIEW_MAX_PAGE_NUM = 5;
	...
	// Tag Search
	public static final Integer TAG_SEARCH_PAGE_SIZE = 10;

	// Popular Tag
	public static final Integer POPULAR_TAG_PAGE_SIZE = 20;

	// 프로필 차단
	public static final Integer PROFILE_BLOCKED_USER_LIST_PAGE_SIZE = 20;

	// 알림 페이지
	public static final Integer NOTIFICATION_PAGE_NUM = 20;
