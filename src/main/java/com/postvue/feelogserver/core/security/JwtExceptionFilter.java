...
import com.postvue.feelogserver.global.http.response.servererrorresponse.ServerErrorResponse;
...
public class JwtExceptionFilter extends OncePerRequestFilter {
	...
	private void setErrorResponse(HttpServletResponse response, String errorMessage) throws IOException {
		...
		ServerErrorResponse serverErrorResponse = new ServerErrorResponse(HttpStatus.UNAUTHORIZED,
